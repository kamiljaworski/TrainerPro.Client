  ...
  function signOutUser() {
    ...
    setTimeout(() => {
      window.location.replace(
        window.location.origin + RouterPaths.LoginRegister
      );
    }, 2000);
  }
...
const UserNavigationBar: React.FC<UserNavigationBar> = ({
  history,
  classes
}) => (
  <Breadcrumbs aria-label="breadcrumb">
    <IconButton
      color="secondary"
      onClick={() => history.push(RouterPaths.UserProfile)}
    ...
    <IconButton
      color="secondary"
      onClick={() => history.push(RouterPaths.Trainers)}
      className={classes.link}
    >
    ...
    <IconButton
      color="secondary"
      onClick={() => history.push(RouterPaths.UserProducts)}
      className={classes.link}
    >
    ...
    <IconButton
      color="secondary"
      onClick={() => history.push(RouterPaths.UserTrainings)}
      className={classes.link}
    >
...
const TrainerNavigationBar: React.FC<UserNavigationBar> = ({
  history,
  classes
}) => (
  <Breadcrumbs aria-label="breadcrumb">
    ...
    <IconButton
      color="secondary"
      onClick={() => history.push(RouterPaths.MyClients)}
      className={classes.link}
    >
      <Accessibility className={classes.icon} />
      Moi klienci
